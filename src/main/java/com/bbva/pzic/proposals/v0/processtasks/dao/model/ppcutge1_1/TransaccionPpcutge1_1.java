...
public class TransaccionPpcutge1_1 implements InvocadorTransaccion<PeticionTransaccionPpcutge1_1,RespuestaTransaccionPpcutge1_1> {
	...
	@Override
	public RespuestaTransaccionPpcutge1_1 invocar(PeticionTransaccionPpcutge1_1 transaccion) throws ExcepcionTransaccion {
	...
	@Override
	public RespuestaTransaccionPpcutge1_1 invocarCache(PeticionTransaccionPpcutge1_1 transaccion) throws ExcepcionTransaccion {
		return servicioTransacciones.invocar(PeticionTransaccionPpcutge1_1.class, RespuestaTransaccionPpcutge1_1.class, transaccion);
	}
